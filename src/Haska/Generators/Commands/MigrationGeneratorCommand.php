...
use Haska\Generators\Parsers\MigrationNameParser;
use Haska\Generators\Parsers\MigrationFieldsParser;
use Haska\Generators\Generator;
use Haska\Generators\SchemaCreator;
use Config;
...
class MigrationGeneratorCommand extends GeneratorCommand {
    ...
    /**
     * @var \Haska\Generators\ModelGenerator
     */
    protected $generator;
