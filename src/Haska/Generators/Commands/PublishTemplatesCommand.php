<?php namespace Haska\Generators\Commands;
...
class PublishTemplatesCommand extends Command {
    ...
    public function fire()
    {
        ...
        $this->call('config:publish', ['package' => 'haska/laravel-generators']);
    ...
    {
        $configPath = app_path('config/packages/haska/laravel-generators/config.php');
        $updated = str_replace('vendor/haska/laravel-generators/src/Haska/Generators/templates', $this->option('path'), File::get($configPath));
